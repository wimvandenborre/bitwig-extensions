...
|-------|---------|-------|------------|--------|
| 5.1 | `0.5.1` | Spike: Validate insertFile() mechanism | in-session | done |
| 5.2 | `0.5.2` | DeviceLibrary utility + unit tests | team | done |
| 5.3 | `0.5.3` | Device insertion + removal RPC handlers | team | done |
| 5.4 | `0.5.4` | Tool schemas + system prompt update | team | done |
| 5.5 | `0.5.5` | CLI DeviceCommand + smoke tests | team | done |
