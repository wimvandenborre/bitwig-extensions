...
|-------|---------|-------|------------|--------|
| 7.1 | `0.7.1` | Known behaviors + error recovery sections | in-session | pending |
| 7.2 | `0.7.2` | Operational music reference | in-session | pending |
| 7.3 | `0.7.3` | Song building section + recommended call sequences | in-session | pending |
| 7.4 | `0.7.4` | Tool description warnings + smoke tests | in-session | pending |
