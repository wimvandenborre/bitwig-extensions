...
|-------|---------|-------|------------|--------|
| 9.1 | `0.9.1` | Spike: validate position-jump envelope writing | in-session | pending |
| 9.2 | `0.9.2` | Per-parameter automation methods + snapshot | in-session | pending |
| 9.3 | `0.9.3` | writeEnvelope with state save/restore | in-session | pending |
| 9.4 | `0.9.4` | Tool schemas + system prompt update | in-session | pending |
| 9.5 | `0.9.5` | Unit tests + smoke tests | in-session | pending |
