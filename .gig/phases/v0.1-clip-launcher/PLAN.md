...
|-------|---------|-------|------------|--------|
| 1.1 | `0.1.1` | Gradle project scaffold + extension definition | in-session | done |
| 1.2 | `0.1.2` | LED colors constants + SysEx helpers | in-session | done |
| 1.3 | `0.1.3` | Clip launcher grid (8x8 pads + LED feedback) | in-session | done |
| 1.4 | `0.1.4` | Scene launch buttons + top row navigation/transport | in-session | done |
| 1.5 | `0.1.5` | Integration testing + polish | in-session | done |
| 1.6 | `0.1.6` | [UNPLANNED] Manual testing fixes | in-session | done |
